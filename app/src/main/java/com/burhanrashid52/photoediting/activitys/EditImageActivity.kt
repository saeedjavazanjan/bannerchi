...
import com.burhanrashid52.photoediting.fragmens.EmojiBSFragment.EmojiListener
import com.burhanrashid52.photoediting.fragmens.StickerBSFragment.StickerListener
...
import com.burhanrashid52.photoediting.fragmens.EmojiBSFragment
import com.burhanrashid52.photoediting.fragmens.PropertiesBSFragment
import com.burhanrashid52.photoediting.fragmens.ShapeBSFragment
import com.burhanrashid52.photoediting.fragmens.StickerBSFragment
...
class EditImageActivity : BaseActivity(), OnPhotoEditorListener, View.OnClickListener,
    ...
    private var selectedTypeface:Typeface?=mWonderFont
    ...
    var fontF:String?=null
    var fontP:String?=null
    @VisibleForTesting
    ...
    override fun onEditTextChangeListener(rootView: View?, text: String?, colorCode: Int) {
        ...
        textEditorDialogFragment.mWonderFont=selectedTypeface
        textEditorDialogFragment.setOnTextEditorListener (object : TextEditorDialogFragment.TextEditorListener {
            override fun onDone(inputText: String?, colorCode: Int,typeface: Typeface) {
                selectedTypeface=typeface//Typeface.createFromAsset(mTxtCurrentTool!!.context.assets, fontpath+fontFamily)

                val styleBuilder = TextStyleBuilder()
                styleBuilder.withTextColor(colorCode)
                //styleBuilder.withTextStyle(selectedTypeface)
                if (rootView != null) {
                    mPhotoEditor?.editText(rootView,selectedTypeface, inputText,colorCode)
                }

                mTxtCurrentTool?.setText(R.string.label_text)
             /*   mTxtCurrentTool!!.setTypeface(

                        Typeface.createFromAsset(mTxtCurrentTool!!.context.assets, fontpath+fontFamily))
*/
            }
        })
    }
                        ...
                        mPhotoEditor?.saveAsFile(
                            ...
                            object : OnSaveListener {
                                override fun onSuccess(imagePath: String) {
                                    ...
                                    hideLoading()
                                    showSnackbar("با موفقیت ذخیره شد")
                                    mSaveImageUri = uri
                                ...
                                override fun onFailure(exception: Exception) {
                                    hideLoading()
                                    showSnackbar("مشکلی رخ داده است")
                                }
                            })
                    } else {
                        hideLoading()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
               ...
               /*     val params = mPhotoEditorView?.source?.layoutParams as RelativeLayout.LayoutParams
                    params.width = FrameLayout.LayoutParams.MATCH_PARENT
                    params.height = FrameLayout.LayoutParams.MATCH_PARENT
                    mPhotoEditorView?.source?.layoutParams = params
*/
                }
                PICK_REQUEST -> try {
                    mPhotoEditor?.clearAllViews()
            ...
            ToolType.TEXT -> {
                ...
                textEditorDialogFragment.setOnTextEditorListener(object : TextEditorDialogFragment.TextEditorListener {
                    override fun onDone(inputText: String?, colorCode: Int,typeface: Typeface) {
                        ...
                        mPhotoEditor?.addText(selectedTypeface,inputText, colorCode)
...
*/
            ...
            ToolType.STICKER -> {
                ...
                intent.type = "image/*"
                intent.action = Intent.ACTION_GET_CONTENT
                startActivityForResult(Intent.createChooser(intent, "انتخاب تصویر"), CANVAS_REQUEST)
            }
            else -> {}
        }
    }
    ...
    companion object {
        ...
        private const val CANVAS_REQUEST=54
